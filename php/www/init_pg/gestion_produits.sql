-- PostgreSQL adaptation of MySQL dump for database: gestion_produits

-- Create the database (optional if already connected to it)
...
(2,'Selle FIZIK ARIONE VERSUS Rails Kium',59.99,'Modèle confortable avant tout, la selle FIZIK Arione Versus...'),
...
(5,'Fourche DVO SAPPHIRE 29',549.99,'Dérivée de la Diamond, la fourche DVO Sapphire 29" marque l\'entrée de la marque californienne...');
